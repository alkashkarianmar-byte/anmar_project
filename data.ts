...
export const initialData: StudentData = {
  ...
  achievements: [
    ...
    { id: 'initial-presentation', type: 'presentation', title: 'عرض الإنجازات', content: 'حصلت على المركز الثاني في مسابقة العلوم المدرسية عن مشروعي حول الطاقة المتجددة.', file: undefined, comments: [
